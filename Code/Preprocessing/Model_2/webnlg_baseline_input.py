...
def delexicalisation(out_src, out_trg, category, properties_objects):
    ...
    for subject in delex_subj:
        ...
        if clean_subj in out_src:
            # The space was removed as there were words to be replaced at the end of the
            # string and instead of having a space after,they have a \n character.
    ...
    for entr in b.entries:
        ...
        for lex in lexics:
            ...
            for triple in tripleset.triples:
                triple_str = triple.s + ' ' + triple.p + ' ' + triple.o + ' '
